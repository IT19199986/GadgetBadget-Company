...
public class Buyer {
		...
		public String insertBuyer(String name, String address, String email,String phone) 
		{ 
			String output = ""; 
			try
			{ 
				...
				String query = " insert into buyer (`ID`,`BuyerName`,`Address`,`Email`,`Phone`)"
							 + " values (?, ?, ?, ?, ?)"; 
		...
		{ 
			...
			{ 
				...
				output = "<table border='1'><tr><th>BuyerName</th><th>Address</th>" +
						"<th>Email</th>" + 
						"<th>Phone</th>" +
		...
		public String updateBuyer(String id, String name, String address, String email, String phone)
		{ 
			String output = ""; 
			try
			{ 
				...
				// create a prepared statement
				String query = "UPDATE buyer SET BuyerName=?,Address=?,Email=?,Phone=? WHERE ID=?"; 
